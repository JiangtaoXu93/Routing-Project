...
```
### Plot for KNN Neighbors vs Accuracy
```{r, warning=FALSE, cache=TRUE} 
plot(model.knn)
```
...
final.score<-data.frame(score.delay.count,score.nondelay.count,score.total.count,score.total)
